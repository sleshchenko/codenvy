...
-- from Codenvy S.A..
--
-- TODO Rework migration script just to remove old resources and create new column for resources caps
...
INSERT INTO organization_resources(organization_id)
SELECT organization_id
FROM organization_distributed_resources;

INSERT INTO organization_resources_caps(organization_resources_id, resource_id)
