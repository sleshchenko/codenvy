...
/**
 * Tests for {@link UserResourceServicesPermissionsChecker}
 *
 * @author Sergii Leschenko
 */
@Listeners(MockitoTestNGListener.class)
public class UserResourceServicesPermissionsCheckerTest {
    @Mock
    private Subject subject;

    private UserResourceServicesPermissionsChecker permissionsChecker;

    @BeforeMethod
    public void setUp() throws Exception {
        permissionsChecker = new UserResourceServicesPermissionsChecker();
    ...
    public void shouldNotThrowExceptionWhenCurrentUserIdEqualsToRequestedAccountId() throws Exception {
        ...
        //when
        permissionsChecker.checkPermissions("user123");
    }
