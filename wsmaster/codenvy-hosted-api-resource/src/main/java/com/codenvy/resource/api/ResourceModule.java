...
import com.codenvy.resource.api.license.LicenseService;
...
import com.codenvy.resource.api.usage.UserResourceServicesPermissionsChecker;
...
public class ResourceModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        Multibinder.newSetBinder(binder(), ResourceServicesPermissionsChecker.class)
                   .addBinding().to(UserResourceServicesPermissionsChecker.class);
