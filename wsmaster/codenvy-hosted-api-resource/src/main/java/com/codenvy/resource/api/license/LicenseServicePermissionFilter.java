...
/**
 * Restricts access to methods of {@link LicenseService} by users' permissions.
 *
 * <p>Filter contains rules for protecting of all methods of {@link LicenseService}.<br>
...
@Filter
@Path("/license{path:(/.*)?}")
public class LicenseServicePermissionFilter extends CheMethodInvokerFilter {
    ...
    @Inject
    public LicenseServicePermissionFilter(AccountManager accountManager,
