...
/**
 * Tests for {@link ResourcesServicePermissionsFilter}
 *
 * @author Sergii Leschenko
 */
@Listeners(value = {MockitoTestNGListener.class, EverrestJetty.class})
public class ResourcesServicePermissionsFilterTest {
    ...
    @Spy
    @InjectMocks
    private ResourcesServicePermissionsFilter filter;
    ...
    public Object[][] pathsProvider() {
        return new Object[][] {
                {"/resources/account123"},
                {"/resources/account123/available"},
                {"/resources/account123/used"},
        };
    }
