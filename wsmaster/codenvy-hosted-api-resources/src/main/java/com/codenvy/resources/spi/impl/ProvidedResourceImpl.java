 ...
 * from Codenvy S.A..
 */
package com.codenvy.resources.spi.impl;

import com.codenvy.resources.model.ProvidedResource;
 ...
 */
public class ProvidedResourceImpl implements ProvidedResource {
    ...
    public ProvidedResourceImpl(String provider,
                                String id,
                                String owner,
                                Long startTime,
                                Long endTime,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ProvidedResourceImpl)) return false;
        ProvidedResourceImpl that = (ProvidedResourceImpl)o;
