...
import com.codenvy.resources.model.License;
...
public class LicenseImpl implements License {
    ...
    private final List<ProvidedResourceImpl> resourcesDetails;
    private final List<AbstractResource>     totalResources;

    public LicenseImpl(String owner,
                       List<ProvidedResourceImpl> resourcesDetails,
    ...
    @Override
    public List<ProvidedResourceImpl> getResourcesDetails() {
