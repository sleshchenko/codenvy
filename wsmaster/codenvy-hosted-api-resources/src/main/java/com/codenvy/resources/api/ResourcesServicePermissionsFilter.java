...
/**
 * Restricts access to methods of {@link ResourcesService} by users' permissions
 *
 * <p>Filter contains rules for protecting of all methods of {@link ResourcesService}.<br>
...
@Filter
@Path("/resources{path:(/.*)?}")
public class ResourcesServicePermissionsFilter extends CheMethodInvokerFilter {
    @Inject
