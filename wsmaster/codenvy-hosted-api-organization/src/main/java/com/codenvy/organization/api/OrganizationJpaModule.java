...
import com.codenvy.organization.spi.jpa.JpaOrganizationResourcesLimitDao;
import com.google.inject.AbstractModule;
import com.google.inject.TypeLiteral;
import com.google.inject.multibindings.Multibinder;

import static com.codenvy.organization.spi.jpa.JpaOrganizationResourcesLimitDao.RemoveOrganizationResourcesLimitBeforeOrganizationRemovedEventSubscriber;
...
public class OrganizationJpaModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(OrganizationResourcesLimitDao.class).to(JpaOrganizationResourcesLimitDao.class);
        bind(RemoveOrganizationResourcesLimitBeforeOrganizationRemovedEventSubscriber.class).asEagerSingleton();
    }
}
