 ...
 */
@Singleton
public class OrganizationResourceServicesPermissionsChecker implements ResourceServicesPermissionsChecker {
    public void checkPermissions(String accountId) throws ForbiddenException {
