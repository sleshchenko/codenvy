...
/**
 * Tests for {@link OrganizationResourceServicesPermissionsChecker}
 *
 * @author Sergii Leschenko
 */
@Listeners(MockitoTestNGListener.class)
public class OrganizationResourceServicesPermissionsCheckerTest {
    @Mock
    private Subject subject;

    private OrganizationResourceServicesPermissionsChecker permissionsChecker;

    @BeforeMethod
    public void setUp() throws Exception {
        permissionsChecker = new OrganizationResourceServicesPermissionsChecker();
    ...
    public void shouldNotThrowExceptionWhenUserHasPermissionToCreateWorkspaces() throws Exception {
        ...
        //when
        permissionsChecker.checkPermissions("organization123");
