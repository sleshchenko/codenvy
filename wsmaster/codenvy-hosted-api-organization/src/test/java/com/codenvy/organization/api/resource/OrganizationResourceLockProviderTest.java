...
/**
 * Tests for {@link OrganizationResourceLockProvider}
 *
 * @author Sergii Leschenko
 */
@Listeners(MockitoTestNGListener.class)
public class OrganizationResourceLockProviderTest {
    @Mock
    private OrganizationManager organizationManager;

    @InjectMocks
    private OrganizationResourceLockProvider lockProvider;
    ...
    public void shouldReturnRootOrganizationId() throws Exception {
        ...
        //when
        final String lockId = lockProvider.getLockId("subsuborg");
