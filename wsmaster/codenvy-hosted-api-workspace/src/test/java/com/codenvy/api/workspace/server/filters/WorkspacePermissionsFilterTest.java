...
/**
 * //TODO Revise tests and their names
 * 
...
public class WorkspacePermissionsFilterTest {
    ...
    public void setUp() throws Exception {
        ...
        permissionsFilter = spy(new WorkspacePermissionsFilter(workspaceManager,
                                                               accountManager,
                                                               ImmutableMap.of(TEST_ACCOUNT_TYPE, accountPermissionsChecker),
    ...
    public void shouldCheckNamespaceAccessOnWorkspaceCreation() throws Exception {
        ...
        verify(permissionsFilter).checkAccountPermissions("userok", AccountAction.CREATE_WORKSPACE);
    ...
    public void shouldCheckNamespaceAccessOnFetchingWorkspacesByNamespace() throws Exception {
        ...
        verify(permissionsFilter).checkAccountPermissions("userok", AccountAction.MANAGE_WORKSPACES);
        verifyZeroInteractions(subject);
    }

    @Test
    public void shouldNotCheckAccountPermissionsIfUserHasSuperPriviligesOnFetchingWorkspacesByNamespace() throws Exception {
        ...
        verify(superPrivilegesChecker).hasSuperPrivileges();
        verify(workspaceService).getByNamespace(any(), eq("userok"));
        verify(permissionsFilter, never()).checkAccountPermissions("userok", AccountAction.MANAGE_WORKSPACES);
        verifyZeroInteractions(subject);
    }
    ...
    public void shouldNotThrowExceptionWhenNamespaceIsNullOnNamespaceAccessChecking() throws Exception {
        ...
        permissionsFilter.checkAccountPermissions(null, AccountAction.MANAGE_WORKSPACES);
    ...
    public void shouldThrowForbiddenExceptionWhenPermissionsCheckerForCorrespondingAccountTypeThrowsForbiddenException() throws Exception {
        ...
        permissionsFilter.checkAccountPermissions("account1", AccountAction.MANAGE_WORKSPACES);
    }
